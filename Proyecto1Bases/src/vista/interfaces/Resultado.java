...
public class Resultado extends javax.swing.JFrame {
    ...
    public Resultado(ResultSet res, ExpresionRelacional relacion) throws Exception{
        
        this.modelo = new DataModel(res); 
        initComponents();
        
        this.textAreaExpresion.setText(relacion.obtenerQuery());
        this.labelRelacional.setText(relacion.obtenerExpresion());
    ...
    private void initComponents() {
        ...
        labelRelacional = new javax.swing.JLabel();
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 63, 370, 50));

        labelRelacional.setOpaque(true);
        jScrollPane3.setViewportView(labelRelacional);
        labelRelacional.getAccessibleContext().setAccessibleName("labelRelacional");

        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(72, 120, 370, 50));
    ...
    private javax.swing.JLabel labelRelacional;
